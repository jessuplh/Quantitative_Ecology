...
par(mfrow = c(1, 2))
biplot(env.pca, scaling = 1, choices = c(1, 7), main = "PCA - scaling 1")
biplot(env.pca, choices = c(1, 7), main = "PCA - scaling 2")  # Default scaling 2

# Plots using cleanplot.pca - NEW VERSION OF THIS FUNCTION which changed syntax

...
alt.dist <- round(vegdist(env[,2], method = "euclidian"), 2)
...
spe.m <- as.tibble(read.csv("Num_Ecol_R_book_ed1/mite.txt", row.names=1))
# Environmental data frame
env.m <- as.tibble(read.csv("Num_Ecol_R_book_ed1/mite_env.txt", row.names=1))
# Spatial data frame – cartesian coordinates
